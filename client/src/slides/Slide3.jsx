    ...
    <Slide className=" text-white">
      <div className="flex flex-col h-full justify-center">
        <div className="flex items-center mb-12">
          ...
          <h2 className="text-6xl font-black px-12 text-white uppercase tracking-tighter">Waarom dit thema?</h2>
          <div className="h-px flex-grow bg-slate-800" />
        </div>
        <div className="grid grid-cols-3 gap-8">
          <div className="bg-slate-900/50 p-8 border border-slate-800 relative overflow-hidden group">
